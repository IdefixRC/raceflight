...
F4_TARGETS       = REVO REVO_OPBL SPARKY2 SPARKY2_OPBL REVONANO REVONANO_OPBL ALIENFLIGHTF4 BLUEJAYF4 VRCORE QUANTON QUANTON_OPBL AQ32_V2 COLIBRI COLIBRI_OPBL

F405_TARGETS     = REVO REVO_OPBL SPARKY2 SPARKY2_OPBL ALIENFLIGHTF4 BLUEJAYF4 VRCORE QUANTON AQ32_V2
F405_TARGETS_16  = QUANTON QUANTON_OPBL COLIBRI COLIBRI_OPBL
...
OPBL_VALID_TARGETS = CC3D_OPBL REVO_OPBL REVONANO_OPBL SPARKY2_OPBL QUANTON_OPBL COLIBRI_OPBL
...
ifeq ($(TARGET),$(filter $(TARGET), COLIBRI_OPBL))
TARGET_FLAGS := $(TARGET_FLAGS) -DCOLIBRI
TARGET_DIR = $(ROOT)/src/main/target/COLIBRI
TARGET_SRC = $(notdir $(wildcard $(TARGET_DIR)/*.c))
endif
