...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
	...
	// { TIM1, GPIOB, Pin_15, TIM_Channel_3, TIM1_CC_IRQn, 0, GPIO_Mode_AF, GPIO_PinSource15, GPIO_AF_TIM1},       // S4_OUT - PB15 
	...
	// { TIM1, GPIOB, Pin_14, TIM_Channel_2, TIM1_CC_IRQn, 0, GPIO_Mode_AF, GPIO_PinSource14, GPIO_AF_TIM1},       // S6_OUT - PB14 
...
#define USED_TIMERS  ( TIM_N(1) | TIM_N(2) | TIM_N(3) | TIM_N(5) | TIM_N(8) | TIM_N(10) | TIM_N(11) | TIM_N(12))
